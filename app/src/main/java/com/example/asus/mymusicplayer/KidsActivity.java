...
public class KidsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        musics.add ( new Music ( R.drawable.baloons, "For Kids", "Lulabies", R.raw.daw ) );
        musics.add ( new Music ( R.drawable.books, "For Kids", "Audiobook", R.raw.wad ) );
        musics.add ( new Music ( R.drawable.music, "For Kids", "Gentle Music", R.raw.wad ) );
        ...
        listView.setOnItemClickListener ( new AdapterView.OnItemClickListener () {
                                              ...
                                              public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                                                  ...
                                                  // Create MediaPlayer
                                                  mMediaPlayer = MediaPlayer.create ( KidsActivity.this, music.getmAudioResourceId () );
