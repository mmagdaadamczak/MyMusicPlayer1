...
public class NatureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        musics.add ( new Music ( R.drawable.rain, "Nature", "Rain", R.raw.daw ) );
        musics.add ( new Music ( R.drawable.forest, "Nature", "Forest", R.raw.wad ) );
        musics.add ( new Music ( R.drawable.sea, "Nature", "Sea", R.raw.daw ) );
        musics.add ( new Music ( R.drawable.storm, "Nature", "Storm", R.raw.daw ) );
        ...
        listView.setOnItemClickListener ( new AdapterView.OnItemClickListener () {
                                              ...
                                              public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                                                  ...
                                                  // Create MediaPlayer
                                                  mMediaPlayer = MediaPlayer.create ( NatureActivity.this, music.getmAudioResourceId () );
