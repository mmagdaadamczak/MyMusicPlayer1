...
public class NoiseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        musics.add ( new Music ( R.drawable.traffic, "Noise", "Sounds of city", R.raw.daw ) );
        musics.add ( new Music ( R.drawable.whte_noise, "Noise", "White noise", R.raw.daw ) );
        ...
        listView.setOnItemClickListener ( new AdapterView.OnItemClickListener () {
                                              ...
                                              public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                                                  ...
                                                  // Create MediaPlayer
                                                  mMediaPlayer = MediaPlayer.create ( NoiseActivity.this, music.getmAudioResourceId () );
